(function ()
{
    ...
    angular
        .module('app.core')
        .factory('appGenerator', appGeneratorService);

    /** @ngInject */
    function appGeneratorService($cookies, $log, appTheming)
    {
        ...
        function generate()
        {
            var registeredThemes = appTheming.getRegisteredThemes();
            var registeredPalettes = appTheming.getRegisteredPalettes();
        ...
        function processAndStoreThemes(_themes)
        {
            ...
            appTheming.setThemesList(themes);
            ...
            if ( selectedTheme )
            {
                appTheming.setActiveTheme(selectedTheme);
            }
            else
            {
                appTheming.setActiveTheme('default');
            }
        }
